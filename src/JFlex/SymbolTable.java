...
public class SymbolTable extends LexerScanner {
    ...
    public void Create_Table() {
        ...
        for (int i = 0; i < no_Token; i++) {
            if ((i >= 1) && (!Token_text[i].equals("String")) && Token_Type[i].equals("IDENTIFIER")
                    && (Exist_Token(Table, Token_text[i], no_Token, 1) == -1) && !Token_Type[i - 1].equals("PACKAGE")
                    && !Token_Type[i - 1].equals("CLASS") && ((!Token_Type[i - 1].equals("DOT"))
                    && (!Token_Type[i - 1].equals("INT")) && (!Token_Type[i - 1].equals("FLOAT"))
                    && (!Token_Type[i - 1].equals("DOUBLE")) && (!Token_Type[i - 1].equals("CHAR"))
                    && (!Token_Type[i - 1].equals("SHORT")) && (!Token_Type[i - 1].equals("BYTE"))
                    && (!Token_Type[i - 1].equals("LONG")) && (!Token_Type[i - 1].equals("BOOLEAN")
                    && (!Token_Type[i - 1].equals("VOID")) && (!Token_Type[i - 1].equals("STRING"))))) {
                zzScanError(0);
                //
                ...
                Table[index++][2] = Token_Type[i];
                    ...
                    || Token_Type[i].equals("STRING_LITERAL") || Token_Type[i].equals("BOOLEAN_LITERAL") && !(Token_Type[i - 1].equals("PLUS") && Token_Type[i].equals("MINUS") && Token_Type[i].equals("DIV")
                ...
                if (index_table != -1) {
                    if (Table[index_table][2].equals("INT")) {
                        ...
                        if (Token_Type[i].equals("CHARACTER_LITERAL")) {
                            ...
                            zzScanError(1);
                            // Character Type with wrong Value
                        }
